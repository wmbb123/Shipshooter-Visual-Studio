...
namespace Blank_Game
{
    class Player2
    {
        ...
        public Player2(List<Laser> laserList)
        {
            pos = new Vector2(640, 524);
            angle = 0f;
            rateOfFire = 20;
            turnSpeed = 0.08f;
            maxSpeed = 5;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, pos, sourceRectangle, Color.Red, angle, origin, 1.0f, SpriteEffects.None, 1);
        }
